...
class Post extends BaseModel
{
	...
	{
		return $this->belongsTo('Qdiscuss\Core\Models\Discussion', 'discussion_id');
	}
	...
	{
		return $this->belongsTo('Qdiscuss\Core\Models\User', 'edit_user_id');
	}
	...
	{
		return $this->belongsTo('Qdiscuss\Core\Models\User', 'hide_user_id');
	}
