...
use Qdiscuss\Core\Exceptions\InvalidConfirmationTokenException;
use Illuminate\Database\Capsule\Manager as DB;
use Qdiscuss\Core\Events\UserWasDeleted;
use Qdiscuss\Core\Events\UserWasRegistered;
use Qdiscuss\Core\Events\UserWasRenamed;
use Qdiscuss\Core\Events\UserEmailWasChanged;
use Qdiscuss\Core\Events\UserPasswordWasChanged;
use Qdiscuss\Core\Events\UserBioWasChanged;
use Qdiscuss\Core\Events\UserAvatarWasChanged;
use Qdiscuss\Core\Events\UserWasActivated;
use Qdiscuss\Core\Events\UserEmailWasConfirmed;
...
class User extends BaseModel
{
	...
	public static function register($username, $display_name, $email, $password, $wp_user_id)
	{
		...
		// just comment for develop neychang??
	...
	{
		$this->bio = $bio;
		$this->bio_html = static::formatBio($this->bio);// neychang add diff from source
	...
	{
		return $this->avatar_path ? qdiscuss_asset($this->avatar_path) : null;
	}
	...
	{
		return $this->hasMany('Qdiscuss\Core\Models\Activity');
	}
	...
	{
		return $this->belongsToMany('Qdiscuss\Core\Models\Group', 'users_groups');
	}
	...
	{
		return $this->hasMany('Qdiscuss\Core\Models\Notification');
	}
	...
	{
		return $this->hasMany('Qdiscuss\Core\Models\AccessToken');
	}
